...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      checkFile = document.querySelectorAll('.check-file'); // checkNumInputs('input[name="user_phone"]');
  ...
  var clearInputs = function clearInputs() {
    ...
    checkFile.forEach(function (fileName) {
  ...
  upload.forEach(function (item) {
    item.addEventListener('input', function () {
      ...
      checkFile.forEach(function (fileName, i) {
        fileName.textContent = arr[0].substring(0, 10) + dots + arr[1];
      });
    });
  });
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var api; // Checking the nearest parent element
...
var modals = function modals() {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        windows.forEach(function (item) {
          item.style.display = 'none'; // Add styles when clicking on modal windows
  ...
  bindModal('.button-consultation', '.popup-consultation', '.popup-consultation .popup-close'); // bindModal('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true);
